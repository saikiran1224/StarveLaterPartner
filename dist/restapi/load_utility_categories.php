...
header('Content-type: application/json');
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT * from restaurants where City = '$city_name' and Area = '$area_name' and Category = '$type'";
  ...
  if(! $result ) {
    ...
    echo json_encode(["status" => true, "msg" => "Records Loaded Successfully" ,"data" => $res_array]); 
